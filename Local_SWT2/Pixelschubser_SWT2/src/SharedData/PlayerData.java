...
public class PlayerData implements Serializable{
	...
	/**
	 * returns the number of promised cards this player has
	 */
	public int getNumberOfPromisedCards() {
	...
	public ActionCard getCardByID(String cardID) {
		for (ActionCard a : cards) {
